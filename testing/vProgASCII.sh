...
echo ""
echo "Starting ASCII starting verification script"
echo "-------------------------------------------"
...
mapfile -t array -n 17 < <(./battletanks -ui ascii -maxturn 1)
RETVAL=$?
